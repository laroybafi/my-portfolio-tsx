...
function useTooltip(originalProps) {
  ...
  const getTooltipProps = (0, import_react2.useCallback)(
    () => ({
      ...
      ...(0, import_utils.mergeProps)(tooltipProps, positionProps, overlayProps, otherProps),
      id: tooltipId
    }),
    [
      baseStyles,
  ...
  const getArrowProps = (0, import_react2.useCallback)(
    () => ({
...
var Tooltip = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const arrowContent = (0, import_react3.useMemo)(() => {
    if (!showArrow)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ...getArrowProps() });
  }, [showArrow, getArrowProps]);
  const animatedContent = (0, import_react3.useMemo)(() => {
    const { className, ...otherTooltipProps } = getTooltipProps();
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...otherTooltipProps, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_framer_motion.motion.div,
      {
        ...
        ...motionProps,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, { className, children: [
          content,
          arrowContent
        ] })
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    trigger,
    disableAnimation && isOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_overlays2.OverlayContainer, { portalContainer, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, { ...getTooltipProps(), children: [
      content,
      arrowContent

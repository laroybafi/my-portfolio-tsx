...
async function optimizeImage({ buffer , contentType , quality , width , height , nextConfigOutput  }) {
    ...
    if (sharp) {
        ...
        if (contentType === AVIF) {
            if (transformer.avif) {
                ...
                console.warn(_chalk.default.yellow.bold("Warning: ") + `Your installed version of the 'sharp' package does not support AVIF images. Run 'npm i sharp@latest' to upgrade to the latest version.\n` + "Read more: https://nextjs.org/docs/messages/sharp-version-avif");
                transformer.webp({
                    quality
                });
            }
    ...
    // End sharp transformation logic
        ...
        if (showSharpMissingWarning) {
            console.warn(_chalk.default.yellow.bold("Warning: ") + `For production Image Optimization with Next.js, the optional 'sharp' package is strongly recommended. Run 'npm i sharp', and Next.js will use it automatically for Image Optimization.\n` + "Read more: https://nextjs.org/docs/messages/sharp-missing-in-production");

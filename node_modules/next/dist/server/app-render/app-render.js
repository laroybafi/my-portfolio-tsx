...
function findMatchedComponent(loaderTree, componentType, result) {
    ...
    for (const key of childKeys){
        ...
        const matchedComponent = findMatchedComponent(childTree, componentType, result);
        if (matchedComponent) {
...
async function renderToHTMLOrFlight(req, res, pagePath, query, renderOpts) {
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: tree , parentParams , firstItem , rootLayoutIncluded , injectedCSS , injectedFontPreloadTags , asNotFound , metadataOutlet  })=>{
       ...
       */ const rootLayoutIncludedAtThisLevelOrAbove = rootLayoutIncluded || rootLayoutAtThisLevel;
            const [NotFound, notFoundStyles] = notFound ? await createComponentAndStyles({
                ...
                rootLayoutIncluded ? undefined : _error.NotFound
            ];
       ...
       */ const currentParams = // Handle null case where dynamic param is optional
            ...
            (segment === "__DEFAULT__" && !parallelRouteMap.length || // For production build the original pathname is /_not-found, always render not-found component.
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound , metadataOutlet  })=>{
        ...
        async function getNotFound(tree, injectedCSS) {
     ...
     */ const createServerComponentsRenderer = (loaderTreeToRender)=>(0, _createservercomponentsrenderer.createServerComponentRenderer)(async (props)=>{
                ...
                return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, styles, /*#__PURE__*/ _react.default.createElement(AppRouter, {
                    ...
                    initialHead: // Adding requestId as react key to make metadata remount for each render
                    /*#__PURE__*/ _react.default.createElement(MetadataTree, {
                        key: requestId
                    }),
        ...
        const bodyResult = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
            ...
            try {
                    ...
                    streamOptions: {
                        ...
                        bootstrapScripts: [
                            ...subresourceIntegrityManifest ? buildManifest.rootMainFiles.map((src)=>({
                                    src: `${assetPrefix}/_next/` + src + // Always include the timestamp query in development
                                    // as Safari caches them during the same session, no
                                    // matter what cache headers are set.
                                    getAssetQueryString(true),
                                    integrity: subresourceIntegrityManifest[src]
                                })) : buildManifest.rootMainFiles.map((src)=>`${assetPrefix}/_next/` + src + // Always include the timestamp query in development
                                // as Safari caches them during the same session, no
                                // matter what cache headers are set.
                                getAssetQueryString(true))
                        ]
                ...
                const ErrorPage = (0, _createservercomponentsrenderer.createServerComponentRenderer)(async ()=>{
                    ...
                    const notFoundLoaderTree = is404 ? createNotFoundLoaderTree(tree) : tree;
                    ...
                    const injectedCSS = new Set();
                    const injectedFontPreloadTags = new Set();
                    const [RootLayout, rootStyles] = await getRootLayout(tree, injectedCSS, injectedFontPreloadTags);
                    const [NotFound, notFoundStyles] = await getNotFound(!renderOpts.dev && renderOpts.originalPathname === "/_not-found" ? notFoundLoaderTree : tree, injectedCSS);
                    ...
                    const notFoundElement = /*#__PURE__*/ _react.default.createElement(ErrorLayout, {
                        params: {}
                    }, /*#__PURE__*/ _react.default.createElement(MetadataOutlet, null), rootStyles, notFoundStyles, /*#__PURE__*/ _react.default.createElement(GlobalNotFound, null));

...
async function startWatcher(opts) {
    ...
    _shared.traceGlobals.set("distDir", distDir);
    _shared.traceGlobals.set("phase", _constants.PHASE_DEVELOPMENT_SERVER);
    ...
    if (opts.turbo) {
        ...
        async function writeMiddlewareManifest() {
            ...
            await (0, _promises.writeFile)(middlewareManifestPath, JSON.stringify({
                sortedMiddleware: [],
                middleware: {},
                functions: {},
                version: 2

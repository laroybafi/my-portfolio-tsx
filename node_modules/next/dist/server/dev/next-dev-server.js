...
const _requestutils = require("../lib/server-ipc/request-utils");
...
class DevServer extends _nextserver.default {
    ...
    async logErrorWithOriginalStack(err, type) {
        if (this.isRenderWorker) {
            await (0, _requestutils.invokeIpcMethod)({
    ...
    async getCompilationError(page) {
        if (this.isRenderWorker) {
            const err = await (0, _requestutils.invokeIpcMethod)({
                hostname: this.hostname,
            ...
            return (0, _requestutils.deserializeErr)(err);
        }

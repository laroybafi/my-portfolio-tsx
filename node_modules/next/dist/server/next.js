...
const _proxyrequest = require("./lib/router-utils/proxy-request");
                ...
                if (!customServer) {
                    ...
                    customServer.on("upgrade", async (req, socket, head)=>{
                        if (shouldUseStandaloneMode) {
                            await (0, _proxyrequest.proxyRequest)(req, socket, _url.default.parse(`http://127.0.0.1:${serverPort}${req.url}`, true), head);
                        }
                    });
                }
            }
                            ...
                            return ()=>{
                                ...
                                return async (req, res, parsedUrl)=>{
                                    if (shouldUseStandaloneMode) {
                                        ...
                                        const proxyParsedUrl = _url.default.parse(`http://127.0.0.1:${serverPort}${req.url}`, true);
                                        if ((_ref = req == null ? void 0 : req.socket) == null ? void 0 : _ref.encrypted) {
                                            req.headers["x-forwarded-proto"] = "https";
                                        }
                                        (0, _requestmeta.addRequestMeta)(req, "__NEXT_INIT_QUERY", proxyParsedUrl.query);
                                        await (0, _proxyrequest.proxyRequest)(req, res, proxyParsedUrl, undefined, req);
                                        return;
                                    }
                    ...
                    case "render":
                        {
                            return async (req, res, pathname, query, parsedUrl)=>{
                                if (shouldUseStandaloneMode) {
                                    ...
                                    (0, _requestmeta.addRequestMeta)(req, "__NEXT_INIT_QUERY", (parsedUrl == null ? void 0 : parsedUrl.query) || query || {});
                                    await (0, _proxyrequest.proxyRequest)(req, res, _url.default.parse(`http://127.0.0.1:${serverPort}${req.url}`, true), undefined, req);
                                    return;
                                }

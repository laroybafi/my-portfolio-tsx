...
export async function initialize(opts) {
    ...
    if (!!config.experimental.appDir) {
        renderWorkers.app = await createWorker(ipcPort, ipcValidationKey, opts.isNodeDebugging, "app", config);
    }
    renderWorkers.pages = await createWorker(ipcPort, ipcValidationKey, opts.isNodeDebugging, "pages", config);
    ...
    const { port , hostname  } = await initializeServerWorker(requestHandler, upgradeHandler, opts);
    initializeResult = {
        port,

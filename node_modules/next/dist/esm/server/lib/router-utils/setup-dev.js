...
import { APP_BUILD_MANIFEST, APP_PATHS_MANIFEST, BUILD_MANIFEST, CLIENT_STATIC_FILES_PATH, COMPILER_NAMES, DEV_CLIENT_PAGES_MANIFEST, DEV_MIDDLEWARE_MANIFEST, NEXT_FONT_MANIFEST, PAGES_MANIFEST, PHASE_DEVELOPMENT_SERVER } from "../../../shared/lib/constants";
...
async function startWatcher(opts) {
    ...
    if (opts.turbo) {
        ...
        async function writeMiddlewareManifest() {
            ...
            await writeFile(middlewareManifestPath, JSON.stringify({
                sortedMiddleware: [],
                middleware: {},
                functions: {},
                version: 2

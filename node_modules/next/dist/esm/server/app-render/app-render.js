...
export async function renderToHTMLOrFlight(req, res, pagePath, query, renderOpts) {
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createServerComponentsRenderer = (loaderTreeToRender)=>createServerComponentRenderer(async (props)=>{
            ...
            try {
                ...
                const ErrorPage = createServerComponentRenderer(async ()=>{
                    ...
                    const notFoundElement = /*#__PURE__*/ React.createElement(ErrorLayout, {
                        params: {}
                    }, /*#__PURE__*/ React.createElement(MetadataOutlet, null), rootStyles, notFoundStyles, /*#__PURE__*/ React.createElement(GlobalNotFound, null));
